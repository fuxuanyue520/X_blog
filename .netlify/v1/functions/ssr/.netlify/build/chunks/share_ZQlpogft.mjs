const id = "share.md";
						...
						const data = {title:"一分钟分享会（严冬已至，春有归期）",description:"一分钟分享会",publishedAt:new Date(1766329200000),tags:[],category:"other",isPinned:true,draft:false};
						const _internal = {
							type: 'content',
							filePath: "C:/Code/X_blog/src/content/posts/share.md",
							rawData: undefined,
						};
