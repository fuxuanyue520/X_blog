const id = "rainy-night-thoughts.md";
						const collection = "posts";
						const slug = "rainy-night-thoughts";
						...
						const data = {title:"雨夜随想",description:"窗外的雨声，是城市最温柔的白噪音。在这样的夜晚，思绪容易飘得很远。",publishedAt:new Date(1765379700000),tags:[],category:"essay",isPinned:false,draft:false};
						const _internal = {
							type: 'content',
							filePath: "C:/Code/X_blog/src/content/posts/rainy-night-thoughts.md",
							rawData: undefined,
						};
